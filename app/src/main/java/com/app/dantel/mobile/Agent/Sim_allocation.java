...
import com.app.dantel.mobile.OpenCloseBatches.CashHistory.AppDatabaseSerials;
import com.app.dantel.mobile.OpenCloseBatches.CashHistory.Serials;
import com.app.dantel.mobile.OpenCloseBatches.CashHistory.SerialsAdapter;
import com.app.dantel.mobile.OpenCloseBatches.CashHistory.SerialsInterface;
...
public class Sim_allocation extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, SearchView.OnQueryTextListener, AdapterView.OnItemClickListener, NetworkStateReceiver.NetworkStateReceiverListener {
    ...
    private static final String TAG = "Sim_allocation";
    ...
    public void onCreate(Bundle savedInstancestate) {
        ...
        Log.d(TAG, "onCreate: druver:"+isDriver+"  "+"Agent:"+isAgent);

package com.app.dantel.mobile.Driver.SignUpAgent;
...
public class CreatedUsersAdapter extends RecyclerView.Adapter<UsersViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(com.app.dantel.mobile.Driver.DriverAttendance.model.get_Agent.Body item);
    }

    private List<FetchAgent> batchesGetLists;
    private List<com.app.dantel.mobile.Driver.DriverAttendance.model.get_Agent.Body> bodyList;

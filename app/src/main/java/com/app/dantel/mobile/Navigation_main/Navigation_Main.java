package com.app.dantel.mobile.Navigation_main;
...
import com.app.dantel.mobile.SharedPreference.SharedPref;
import com.app.dantel.mobile.Web_Services.MyApp;
import com.app.dantel.mobile.Web_Services.RetrofitClient;
                    ...
                    if (response.body() != null) {
                        ...
                        if(authority.equals("ADMIN"))
                        {
                            ...
                            Toast.makeText(Navigation_Main.this, "You are logging in with ADMIN Credentials", Toast.LENGTH_SHORT).show();
                                ...
                                || authority.equals("KCM_DRIVER") || authority.equals("SALES_MANAGER")
                                || authority.equalsIgnoreCase("Dealer") ||
                                authority.equalsIgnoreCase("sub_distributor"))
                        {
                            progressBar.cancel();
                            SharedPreferences.Editor mEditor = mSharedPreferences.edit();
                            mEditor.putString(DRIVER,authority);
                            mEditor.apply();
                            SharedPref.putDriver(Navigation_Main.this,authority);
                            ...
                            startActivity(intent);
                                ...
                                || authority.equals("KCM_AGENT") || authority.equals("SALES_REP_AGENT") ){
                            progressBar.cancel();
                            SharedPreferences.Editor mEditor = aSharedPreferences.edit();
                            mEditor.putString(AGENT,authority);
                            mEditor.apply();
                            SharedPref.putAgent(Navigation_Main.this,authority);
